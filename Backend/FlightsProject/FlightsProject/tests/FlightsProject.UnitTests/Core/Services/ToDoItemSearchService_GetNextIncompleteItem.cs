...
using FlightsProject.Core.ProjectAggregate;
using FlightsProject.Core.Services;
using FlightsProject.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace FlightsProject.UnitTests.Core.Services
{
